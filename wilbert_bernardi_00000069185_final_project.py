# -*- coding: utf-8 -*-
"""Wilbert Bernardi_00000069185_Final Project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13XEo7CfUFQ1q3hvcanJ-5FEB85b8yH8d
...
# Second split: temp into 50% validation and 50% test (which is 10% of original data each)
...
epochs = range(1, 11)
train_losses = [0.8616, 0.7687, 0.7427, 0.7174, 0.7065, 0.6875, 0.6772, 0.6655, 0.6610, 0.6547]
val_losses = [0.7753, 0.7372, 0.7159, 0.6973, 0.6821, 0.6717, 0.6647, 0.6540, 0.6463, 0.6391]
val_accuracies = [0.6702, 0.6996, 0.7038, 0.7206, 0.7332, 0.7374, 0.7395, 0.7353, 0.7395, 0.7374]
...
plt.title('Training and Validation Loss per Epoch (BS 16, LR 2e-5)')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.grid(True)
...
plt.title('Validation Accuracy per Epoch (BS 16, LR 2e-5)')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
plt.grid(True)
...
plt.title('Confusion Matrix for Batch Size 16, Learning Rate 2e-5')
...
results = {
    ...
    'Accuracy': [
        0.7332, 0.6765, 0.6345,
        0.7374, 0.6639, 0.6176,
        0.7164, 0.6576, 0.6324,
        0.7101, 0.6366, 0.6050
    ],
    'Precision': [
        0.7293, 0.7034, 0.6756,
        0.7344, 0.7174, 0.6731,
        0.7189, 0.6968, 0.6633,
        0.7353, 0.6810, 0.6625
    ],
    'Recall': [
        0.7332, 0.6765, 0.6345,
        0.7374, 0.6639, 0.6176,
    ...
    'F1-Score': [
        0.6927, 0.6857, 0.6468,
        0.7016, 0.6796, 0.6328,
        0.6686, 0.6703, 0.6412,
        0.6481, 0.6491, 0.6194
    ]
}
